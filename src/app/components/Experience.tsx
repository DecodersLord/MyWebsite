    ...
    return (
        <section className="min-h-screen px-2 py-10">
            ...
            <div className="relative max-w-6xl mx-auto hidden md:block">
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2 top-0 w-[2px] h-[75vh] bg-slate-700" />

                {/* Year markers on the timeline - only for years with experiences */}
                ...
                <div className="pt-10">
                    {uniqueYears.map((year) => {
                        ...
                        return yearExperiences.map((exp, expIndex) => {
                            ...
                            const isLeft = expIndex % 2 === 0; // Alternate for visual balance within the same year
                            ...
                            return (
                                <motion.div
                                    ...
                                    style={{
                                        top: `${
                                            yearPosition + 50 + expIndex * 100
                                        }px`, // Offset multiple experiences in same year
                                    }}
                                >
                                    {/* Timeline dot positioned at the actual year with offset for multiple experiences */}
                                    <div
                                        ...
                                        style={{
                                            transform: `translate(-50%, ${exp.dotOffset}px)`, // Offset dots for same year
                                        }}
                                    ></div>
                                    ...
                                    {/* Horizontal connector line - always attached to dot */}
                                    <div
                                        className={`absolute w-28 h-[2px] bg-slate-300 dark:bg-slate-700 ${
                                            isLeft ? "right-1/2 " : "left-1/2"
                                        }`}
                                        style={{
                                            top: `calc(2rem + 6px + ${exp.dotOffset}px)`, // top-8 (2rem) + half dot height (6px) + dotOffset
                                        }}
                                    />
                                </motion.div>
                            );
            ...
            {/* Mobile version - keep simple chronological order */}
            <div className="md:hidden relative max-w-md mx-auto">
                <div className="absolute left-6 top-0 bottom-0 w-[2px] bg-slate-300 dark:bg-slate-700" />
                ...
                {experiences.map((exp, i) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <motion.div
                                animate={{
                                    scale: hoverProps.hoverAnimation.scale,
                            ...
                            >
                                <Card
                                    shadow={hoverProps.isHovered ? "lg" : "sm"}
                                >
